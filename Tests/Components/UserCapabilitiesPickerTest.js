...
import UserCapabilitiesPicker from '../../App/Components/UserCapabilitiesPicker'

const wrapper = shallow(<UserCapabilitiesPicker />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('UserCapabilitiesPicker Component')) // That the Component Text is included
})
